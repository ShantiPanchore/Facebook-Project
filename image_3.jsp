...
if(request.getParameter("sender_id")!=null && request.getParameter("sender_id")!="")
{
String id = request.getParameter("sender_id");
...
String strQuery = "select photo from register_facebook where first_name='"+id+"'";
