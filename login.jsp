<%-- 
    Document   : index
    Created on : Jan 11, 2020, 4:39:43 PM
    Author     : user
--%>
    ...
    <head>
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <form action="logindb.jsp" method="post" onsubmit="function check()" name="form1">
                <input type="text" class="txt-mail" placeholder="User Name" name="user">
                 ...
                 <input type="submit" class="txt-btn" value="Log In">
                 <div class="box-links">
                     <a href="forget_password.jsp">Forget Account?</a>
