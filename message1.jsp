<%-- 
    Document   : message1
    Created on : Feb 10, 2020, 1:14:24 PM
    Author     : user
--%>
...
Class.forName("com.mysql.jdbc.Driver");
 con=DriverManager.getConnection("jdbc:mysql://localhost:3306/facebook","root","");
	...
	Statement stmt=con.createStatement();
         String first=request.getParameter("id");
         session.setAttribute("rec",first);
        String strQuery = "select id,first_name from register_facebook where first_name='"+first+"'";
        ...
        int sno=0;
            ...
            sno++;
              ...
              <div class="chat-popup" id="myForm">
                  <form action="msget.jsp" class="form-container" id="myForm">
                      <img src="image_2.jsp?imgid=<%=rs.getInt(1)%>" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
