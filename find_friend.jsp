...
Class.forName("com.mysql.jdbc.Driver");
 con=DriverManager.getConnection("jdbc:mysql://localhost:3306/facebook","root","");
	...
	Statement stmt=con.createStatement();
                ...
                String strQuery = "select id,first_name from register_facebook";
	...
	%>
        ...
        <form action="facebook_profile.jsp" method="post">
       ...
       <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        ...
        <a href="friend_request.jsp?id=<%=rs.getString(2)%>">friend</a>
            <input type="submit" class="w3-button w3-theme-d1 w3-margin-bottom" value="Friend"> </a>
        <button type="button" class="w3-button w3-theme-d2 w3-margin-bottom"><i class="fa fa-comment"></i>Remove</button>
